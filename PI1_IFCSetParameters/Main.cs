    ...
    public class Main : IExternalApplication
    {
        ...
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            var btnAssociatingParametersToGlobalData = new RevitPushButtonData
            {
                Label = "Запись\nпараметров в IFC",
                Panel = ribbonPanel,
                ToolTip = "Заполняет необходимые параметры IFC арматуры для её корректного подсчёта в спецификациях",
                CommandNamespacePath = Command.GetPath(),
                ImageName = "icon_PI1_IFCSetParameters_16х16.png",
                LargeImageName = "icon_PI1_IFCSetParameters_32x32.png"
            };
